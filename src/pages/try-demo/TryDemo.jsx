...
import "../../pages/single-card-view/Bookflip.css";
      ...
      <article className="single_card_view_section">
        ...
        <div className="single_card_page_header">
          <h2 className="single_card_header_h3">
            A card for{" "}
            {signedCardDetails && signedCardDetails.recipientFullName}
          </h2>
        ...
        <div className="single_card_view_footer">
          <div className="single_card_copy_box">
            <p
              ref={user_code}
              style={{ fontSize: "12px" }}
            >{`https://new-heartfelt.vercel.app/single-card-view/${cardId}`}</p>
