...
const CardSettings = ({ baseUrl }) => {
  ...
  async function getCardInfo() {
    ...
    setRecipientFullName(data.details.recipientFullName)
    setRecipientEmail(data.details.recipientEmail)
    setSenderFullName(data.details.senderFullName)
    setDeliveryDate(data.details.date)
    setDeliveryTime(data.details.time)
    setDeliveryTimeZone(data.details.timeZone)
    setSendToEmail(data.details.sendToEmail)
    setNextYearReminder(data.details.setNextYearReminder)
    setAddMedia(data.details.addMedia)
          ...
          <div className="delivery_details_col_1">
            ...
            >
              ...
              <div className="recipient_details preferences">
                ...
                <div>
                  <input
                    ...
                    checked={nextYearReminder}
                    value={nextYearReminder}
                  />
              ...
              {loader ? (
                ...
                <>
                {cardStatus === "2" ?
                    <button className="delivery_form_purchase_btn" onClick={updateCardSettings}>
                        Update Card Settings
                    </button>
                : 
                <button className="delivery_form_purchase_btn" onClick={submitCardDeliveryDetails}>
                        Purchase Card
                </button>
                }
