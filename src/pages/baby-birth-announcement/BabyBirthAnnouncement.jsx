...
const BabyBirhAnnouncement = ({baseUrl}) => {
  ...
  async function fetchCards() {
    const response = await fetch(`${baseUrl}/fetch-cards-category/Birth Announcement`);
  ...
  return (
    <div className="upload-card-cover">
      ...
      <div className="header">
        <h1>Baby/Birth Announcement Cards</h1>
        <p>
...
export default BabyBirhAnnouncement;
